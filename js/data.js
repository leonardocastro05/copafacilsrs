...
const pilotosT36 = [
    { pos: 1, nombre: 'Valdi CT', equipo: '77 Campos Racing F1', puntos: 6 },
    { pos: 2, nombre: 'Cristian Ezpeleta', equipo: '99 Campos Racing F1', puntos: 6 },
    { pos: 3, nombre: 'Andre Prov', equipo: 'Tortuga', puntos: 6 },
    { pos: 4, nombre: 'SERGIO Ruiz Furious', equipo: '88 Honda Marlboro', puntos: 6 },
    { pos: 5, nombre: 'Eduardo Calvo', equipo: '72 CTC VCT Foxtrot', puntos: 6 },
    { pos: 6, nombre: 'Vasvo Lao', equipo: 'Subaru F1 Team', puntos: 6 },
    { pos: 7, nombre: 'Tony Crowther', equipo: 'Leyton House March', puntos: 6 },
    { pos: 8, nombre: 'Antonio Pinillos', equipo: 'Red Bull Pinkustercia F1 Team', puntos: 6 },
    { pos: 9, nombre: 'Templario VCR', equipo: 'Hispania Racing Team', puntos: 6 },
    { pos: 10, nombre: 'Marc cr Rayo', equipo: 'Rayito Team', puntos: 6 },
    { pos: 11, nombre: 'Luis Reynoso', equipo: '22 Alpine F1 Team', puntos: 3 },
    { pos: 12, nombre: 'Blake Ezeh', equipo: 'Deco27 HoloLive Racing Team', puntos: 3 },
    { pos: 13, nombre: 'Alejandro Alonso', equipo: 'BMW F1 Team', puntos: 3 },
    { pos: 14, nombre: 'Giacomina Leclerc', equipo: 'Renfe Cercanias RT 6', puntos: 3 },
    { pos: 15, nombre: 'Peppe Vedda', equipo: 'Iron Racing Team', puntos: 3 },
    { pos: 16, nombre: 'Mauro Reyes', equipo: '26 Zetta Racing', puntos: 3 },
    { pos: 17, nombre: 'Leoo Castro', equipo: '07 CRT Competition', puntos: 3 },
    { pos: 18, nombre: 'Alexis Iceman', equipo: '00 CRT Competition', puntos: 3 },
    { pos: 19, nombre: 'Christian Horny', equipo: '15 Zetta Racing Team', puntos: 3 },
    { pos: 20, nombre: 'Marco Rodriguez', equipo: '94 Pagani Renault', puntos: 3 },
    { pos: 21, nombre: 'Francisco Martinez', equipo: 'Renfe Cercanias RT', puntos: 3 },
    { pos: 22, nombre: 'Sergio Solano', equipo: '13 CRT Competition', puntos: 3 },
    { pos: 23, nombre: 'Juan Garcia', equipo: 'Renault F1 Team', puntos: 0 },
    { pos: 24, nombre: 'Stefano Cann', equipo: 'Italica Siracusa', puntos: 0 },
    { pos: 25, nombre: 'Nelson David Quiroz', equipo: '9 ART Grand Prix', puntos: 0 },
    { pos: 26, nombre: 'Freya Anafi', equipo: 'Subaru Pirelli SRS Team', puntos: 0 },
    { pos: 27, nombre: 'Roma Astur', equipo: '69 CRT Competition', puntos: 0 },
    { pos: 28, nombre: 'Nicolo Civera', equipo: 'Olympic Torino Racing', puntos: 0 },
    { pos: 29, nombre: 'Eduardo Scarpati', equipo: 'ESFX Red Bull Ferrari', puntos: 0 },
    { pos: 30, nombre: 'Cristobal Farias', equipo: '18 Zetta Racing', puntos: 0 },
    { pos: 31, nombre: 'Juan Ignacio', equipo: '74 Subaru Pirelli SRS Team', puntos: 0 },
    { pos: 32, nombre: 'Alvaro Redondo', equipo: '36 CTC VCR FTSE', puntos: 0 }
];
...
const jornadasT36 = [
    ...
    },
    {
        ...
        enfrentamientos: [
            'Leoo Castro vs Roma Astur (gana Leoo Castro)',
