...
const pilotos = [
    { pos: 1,  nombre: "Cristian Ezpeleta",          equipo: "Campos Racing F1 Ezpeleta",         puntos: 24, color: colores[0] },
    { pos: 2,  nombre: "Valdi CT",                   equipo: "El Nano",                           puntos: 21, color: colores[1] },
    { pos: 3,  nombre: "Leoo Castro",                equipo: "07 CRT Competition",                puntos: 24, color: colores[2] },
    { pos: 4,  nombre: "Sergio Solano",              equipo: "Furia Andalusí",                    puntos: 21, color: colores[3] },
    { pos: 5,  nombre: "Vasvo Lao",                  equipo: "Subaru F1 Team",                    puntos: 21, color: colores[4] },
    { pos: 6,  nombre: "Alexis Iceman",              equipo: "00 CRT Competition",                puntos: 18, color: colores[5] },
    { pos: 7,  nombre: "Ruben Medina",               equipo: "Team Chuis",                        puntos: 15, color: colores[6] },
    { pos: 8,  nombre: "André Prov",                 equipo: "Tortuga",                           puntos: 21, color: colores[7] },
    { pos: 9,  nombre: "Frank White",                equipo: "69 CRT Competition",                puntos: 9, color: colores[8] },
    { pos: 10, nombre: "Marco Rodriguez",            equipo: "94 Pagani Renault",                 puntos: 15, color: colores[9] },
    { pos: 11, nombre: "Eduardo Calvo",              equipo: "Foxtrot GP",                        puntos: 18, color: colores[10] },
    { pos: 12, nombre: "Samuel Guevara Salazar",     equipo: "HONDA",                             puntos: 12, color: colores[11] },
    { pos: 13, nombre: "Nelson David Quiroz",        equipo: "9 ART Grand prix",                  puntos: 9, color: colores[12] },
    ...
    { pos: 18, nombre: "Antonio Pinillos",           equipo: "Red Bull Pinkustercia F1 Team",     puntos: 12, color: colores[17] },
