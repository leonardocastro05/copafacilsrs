...
const pilotos = [
    { pos: 1,  nombre: "Cristian Ezpeleta",          equipo: "Campos Racing F1 Ezpeleta",         puntos: 21, color: colores[0] },
    { pos: 2,  nombre: "Valdi CT",                   equipo: "El Nano",                           puntos: 21, color: colores[1] },
    { pos: 3,  nombre: "Leoo Castro",                equipo: "07 CRT Competition",                puntos: 21, color: colores[2] },
    { pos: 4,  nombre: "Sergio Solano",              equipo: "Furia Andalusí",                    puntos: 18, color: colores[3] },
    { pos: 5,  nombre: "Vasvo Lao",                  equipo: "Subaru F1 Team",                    puntos: 18, color: colores[4] },
    { pos: 6,  nombre: "Alexis Iceman",              equipo: "00 CRT Competition",                puntos: 15, color: colores[5] },
    ...
    { pos: 11, nombre: "Eduardo Calvo",              equipo: "Foxtrot GP",                        puntos: 15, color: colores[10] },
    ...
    { pos: 19, nombre: "Alvaro Redondo",             equipo: "72 Akina SpeedStars Fujiwara",      puntos: 12, color: colores[18] },
